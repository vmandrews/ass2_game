...
void testQueueMed()
{
	...
	assert(trapNum(tpvs, 1, 0) == 0);
	assert(trapNum(tpvs, 1, 1) == 0);
	...
	push(tpvs->trap, 1);
	push(tpvs->trap, 2);
	assert(trapNum(tpvs, 12, 0) == 1);
	assert(trapNum(tpvs, 13, 0) == 1);
	assert(trapNum(tpvs, 1, 0) == 1);
	assert(trapNum(tpvs, 2, 0) == 1);
	assert(trapNum(tpvs, 99, 0) == 0);

	puts("\ntesting 2 traps");
	push(tpvs->trap, 12);
	assert(trapNum(tpvs, 12, 0) == 2);
	assert(trapNum(tpvs, 13, 0) == 1);
	assert(trapNum(tpvs, 1, 0) == 1);
	assert(trapNum(tpvs, 2, 0) == 1);
	assert(trapNum(tpvs, 99, 0) == 0);
	...
	push(tpvs->trap, 12);
	push(tpvs->trap, 93);
	assert(trapNum(tpvs, 12, 0) == 3);
	assert(trapNum(tpvs, 13, 0) == 1);
	assert(trapNum(tpvs, 1, 0) == 1);
	assert(trapNum(tpvs, 2, 0) == 1);
	assert(trapNum(tpvs, 99, 0) == 1);
